  ...
  return (
   ...
   {currentQuotes &&(
        <div key={currentQuotes.id}  id="quote-box" className="rounded" style={{color : color}}>
            <div id="text" className="quote-text text-center mx-4 my-4 fs-2 fw-normal">
                {currentQuotes.quote}
            </div>
            ...
            <i className="fa fa-twitter fa-3x my-4 mx-3 animate__animated animate__fadeInDownBig" style={{color : "blue"}} />
            </a>
        </div>
   )}
    </main>
